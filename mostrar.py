'''Aquí damos el comando para que, si se selecciona la opción mostrar catálogo, salga todo el contenido; si no, que solamente
se muestre la opción seleccionada.'''
...
def mostrar_menu():
    while True:
        ...
        opcion = input("Por favor, seleccione un número: ")
